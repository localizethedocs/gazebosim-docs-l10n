...
foreach(_LANGUAGE ${LANGUAGE_LIST})
    ...
    set(GZ_ROOT_INDEX_FILE_PATH     "${PROJ_OUT_REPO_DIR}/index.yaml")
    ...
    execute_process(
        COMMAND ${CMAKE_COMMAND} -E env
                ...
                -D gz_root_index_file=${GZ_ROOT_INDEX_FILE_PATH}
...
set(UPSTREAM_DOCS   "https://gazebosim.org/docs/")
set(UPSTREAM_REPO   "https://github.com/gazebosim/docs")
